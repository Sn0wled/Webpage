...
public class IndexController {
    ...
    public void AddDiscs(Model model){
        ...
        for (Genre genre : genres){
            model.addAttribute(genre.toString().toLowerCase(), filterByGenres(discs, genre));
        }
    }

    private Iterable<Disc> filterByGenres(
        List<Disc> discs, Genre genre
    ){
        return discs.stream()
